...
#-------------------
#https://github.com/z1069614715/objectdetection_script/blob/master/yolo-gradcam/README.md
#-------------------
...
def get_params():
    params = {
        'weight': 'runs/train/custom/0802bestv0.pt',
...
if __name__ == '__main__':
    ...
    source = 'img/'
    imgDir = os.listdir(source)
    for name in imgDir:
        imgPath = source + name
        model(imgPath, 'result/'+name)